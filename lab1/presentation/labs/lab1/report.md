...
author: "Студент: Зашихалиева З.Р."
date: "2026-03-29"
lang: ru-RU
toc: true
toc-depth: 2
...
![График функции y1 (синус)](4.png){#fig:004 width=70%}

На рис. 5 представлен график функции y2 = cos x + (1/3) cos 3x + (1/5) cos 5x.

![График функции y2 (косинус)](5.png){#fig:005 width=70%}

На рис. 6 показаны совмещённые графики обеих функций.

![Совмещённые графики функций](6.png){#fig:006 width=70%}

На рис. 7 представлены табличные данные, использованные для построения графиков.

![Табличные данные для построения](7.png){#fig:007 width=70%}
...
![Файлы проекта в редакторе Octave](26.png){#fig:008 width=70%}

На рис. 9 показаны графики меандра, реализованные с различным количеством гармоник (от 1 до 8).

![Графики меандра с разным числом гармоник](10.png){#fig:009 width=70%}

На рис. 10 представлены параметры пиков сигнала.

![Параметры пиков сигнала](11.png){#fig:010 width=70%}
...
![Код файла spectre.m](11.png){#fig:011 width=70%}
...
![График двух синусоидальных сигналов](12.png){#fig:012 width=70%}
...
![Спектры сигналов (некорректированный)](13.png){#fig:013 width=70%}
...
![Исправленный график спектров](14.png){#fig:014 width=70%}

На рис. 16 и 18 представлены спектры суммы рассмотренных сигналов.

![Спектр суммы сигналов](16.png){#fig:015 width=70%}

![Исправленный спектр суммы сигналов](18.png){#fig:016 width=70%}
...
![Амплитудная модуляция](15.png){#fig:017 width=70%}
...
![Файлы в каталоге coding](20.png){#fig:018 width=70%}

![Код файла main.m](22.png){#fig:019 width=70%}

![Функция maptowave.m](23.png){#fig:020 width=70%}

![Код ami.m](26.png){#fig:021 width=70%}

![Код bipolarnrz.m](27.png){#fig:022 width=70%}

![Код bipolarrz.m](28.png){#fig:023 width=70%}

![Код manchester.m](29.png){#fig:024 width=70%}

![Код diffmanc.m](30.png){#fig:025 width=70%}
...
![Результаты кодирования в каталоге signal](32.png){#fig:026 width=70%}
...
![Проверка самосинхронизации в каталоге sync](33.png){#fig:027 width=70%}
...
![Спектры кодированных сигналов в каталоге spectre](34.png){#fig:028 width=70%}
